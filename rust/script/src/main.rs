use app_core::audio::{get_output_stream, get_user_device, play_audio_data, save_audio_data_to_file};
use app_core::{get_audio_data_from_voicevox, SYNTHESIZE_ENDPOINT, AUDIO_ENDPOINT};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let synthesize_endpoint = format!("{}{}", voicevox_url, SYNTHESIZE_ENDPOINT);
    let audio_endpoint = format!("{}{}", voicevox_url, AUDIO_ENDPOINT);
